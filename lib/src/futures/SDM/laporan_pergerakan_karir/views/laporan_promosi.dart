...
class LaporanPromosi extends StatefulWidget {
  const LaporanPromosi({super.key});

  @override
  State<LaporanPromosi> createState() => _LaporanPromosiState();
}

class _LaporanPromosiState extends State<LaporanPromosi> {
  LaporanPromosiController laporanPromosiC =
      Get.find<LaporanPromosiController>();
  ...
  _fetchPage() {
    ...
    laporanPromosiC.getLaporanPromosi(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: appBarPrimary("Laporan Promosi"),
        body: Padding(
          ...
          child: Column(children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          laporanPromosiC.laporanPromosiM?.data.clear();
                          laporanPromosiC.getLaporanPromosi(
                            firstDate.simpleDate(),
                            lastDate.simpleDate(),
                            page,
            ...
            Obx(
              () => page == 1
                  ? laporanPromosiC.isLoading.value
                      ? loadingPage()
                      : laporanPromosiC.isEmptyData.value
                          ? Container(
                              width: Get.width,
                              height: Get.height / 2,
                              decoration: BoxDecoration(
  ...
  Expanded listData() {
    return Expanded(
      child: ListView.builder(
        ...
        itemCount: laporanPromosiC.laporanPromosiM!.data.length + 1,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          var data = laporanPromosiC.laporanPromosiM?.data;
          if (index < laporanPromosiC.laporanPromosiM!.data.length) {
            return cardItems(
              index + 1,
              data?[index].nip,
            ...
            return Padding(
              ...
              child: Center(
                child: !laporanPromosiC.isEmptyData.value
