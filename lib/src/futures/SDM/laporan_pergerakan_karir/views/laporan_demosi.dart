...
class _LaporanDemosiState extends State<LaporanDemosi> {
  LaporanDemosiConrtoller laporanDemosiC = Get.find<LaporanDemosiConrtoller>();
  ...
  _fetchPage() {
    ...
    laporanDemosiC.getLaporanDemosi(
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: Column(children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          laporanDemosiC.laporanDemosiM?.data.clear();
                          laporanDemosiC.getLaporanDemosi(
                            firstDate.simpleDate(),
                            lastDate.simpleDate(),
                            page,
            ...
            Obx(
              () => page == 1
                  ? laporanDemosiC.isLoading.value
                      ? loadingPage()
                      : laporanDemosiC.isEmptyData.value
                          ? Container(
                              width: Get.width,
                              height: Get.height / 2,
                              decoration: BoxDecoration(
  ...
  Expanded listData() {
    return Expanded(
      child: ListView.builder(
        ...
        itemCount: laporanDemosiC.laporanDemosiM!.data.length + 1,
        shrinkWrap: true,
        itemBuilder: (context, index) {
          var data = laporanDemosiC.laporanDemosiM?.data;
          if (index < laporanDemosiC.laporanDemosiM!.data.length) {
            return cardItems(
              index + 1,
              data?[index].nip,
            ...
            return Padding(
              ...
              child: Center(
                child: !laporanDemosiC.isEmptyData.value
