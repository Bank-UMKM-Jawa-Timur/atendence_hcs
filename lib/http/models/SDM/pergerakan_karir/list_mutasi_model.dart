...
ListMutasiModel listMutasiModelFromJson(String str) =>
    ListMutasiModel.fromJson(json.decode(str));

String listMutasiModelToJson(ListMutasiModel data) =>
    json.encode(data.toJson());

class ListMutasiModel {
  int status;
  String message;
  List<Datum> data;
  ...
  factory ListMutasiModel.fromJson(Map<String, dynamic> json) =>
      ListMutasiModel(
        status: json["status"],
