...
ListDemosiModel listDemosiModelFromJson(String str) =>
    ListDemosiModel.fromJson(json.decode(str));

String listDemosiModelToJson(ListDemosiModel data) =>
    json.encode(data.toJson());

class ListDemosiModel {
  int status;
  String message;
  List<Datum> data;
  ...
  factory ListDemosiModel.fromJson(Map<String, dynamic> json) =>
      ListDemosiModel(
        status: json["status"],
