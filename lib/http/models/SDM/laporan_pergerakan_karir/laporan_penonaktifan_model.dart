...
LaporanPenonaktifanModel laporanPenonaktifanModelFromJson(String str) =>
    LaporanPenonaktifanModel.fromJson(json.decode(str));

String laporanPenonaktifanModelToJson(LaporanPenonaktifanModel data) =>
    json.encode(data.toJson());

class LaporanPenonaktifanModel {
  int status;
  String message;
  List<Datum> data;

  LaporanPenonaktifanModel({
    required this.status,
    required this.message,
    required this.data,
  });

  factory LaporanPenonaktifanModel.fromJson(Map<String, dynamic> json) =>
      LaporanPenonaktifanModel(
        status: json["status"],
