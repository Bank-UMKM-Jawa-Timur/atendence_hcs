...
LaporanDemosiModel laporanDemosiModelFromJson(String str) =>
    LaporanDemosiModel.fromJson(json.decode(str));

String laporanDemosiModelToJson(LaporanDemosiModel data) =>
    json.encode(data.toJson());

class LaporanDemosiModel {
  int status;
  String message;
  List<Datum> data;
  ...
  factory LaporanDemosiModel.fromJson(Map<String, dynamic> json) =>
      LaporanDemosiModel(
        status: json["status"],
